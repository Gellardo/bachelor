...
To begin with, we define, what a regular surface is.
\begin{mydef}[regular surface]
	...
	\begin{enumerate}
		...
		\item For each $q \in U$, the differential $dx_q: \real^2 \rightarrow \real^3 is one to one. Or the Jacobian of $x$ has full rank.
	\end{enumerate}
\end{mydef}
%% 1 -> differential geometry 2->no selfintersections 3->existance of tangent planes everywhere
