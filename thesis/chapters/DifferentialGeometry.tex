...
%TODO citation for using the eikonal equation for geodesic dist
...
%TODO picture of a mesh with geodesic curves on it
...
It is also used to define the directional derivative $d f_{p}(v)$ of f at the point $p$ in the direction of the vector $v \in \mathbb{R}^n$:
%TODO define following the riesz representation theorem
\begin{equation}
